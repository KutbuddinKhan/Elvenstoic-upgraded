...
const Upsell2Popup: React.FC<Upsell2PopupProps> = ({
    ...
    return (
        <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
            <DialogContent className="w-[95vw] max-w-2xl max-h-[95vh] overflow-y-auto overflow-x-hidden bg-yellow-50 border border-yellow-200 rounded-lg p-4 sm:p-6 text-gray-800 mx-auto">
                <DialogHeader>
                    <DialogTitle className="text-xl sm:text-2xl md:text-3xl font-bold text-yellow-900 mb-2 sm:mb-4 text-center leading-tight">
                ...
                <div className="space-y-4 text-sm sm:text-base md:text-lg">
                    ...
                    <p><strong>Do you know what the #1 regret of failed creators is?</strong><br />
                        <em>"I wish I had learned how to monetize sooner."</em></p>

                    <p>They spent <strong>YEARS</strong> building an audience.<br />
                    ...
                    <div>
                        <p className="font-bold text-gray-900 mb-2">Let's Do Some Quick Math:</p>
                        ...
                        <p className="mt-2">What you're "saving": <strong>€297</strong><br />
                    ...
                    <div>
                        <p className="font-bold text-gray-900 mb-2">Here's What's Going to Happen:</p>
                        <span className='text-sm'>In 6 months, you'll be in one of two places:</span>
                        <ul className="list-disc pl-5 space-y-2">
                            <li><strong>Place 1:</strong> Still posting for likes, hoping for brand deals, wondering "what if?"</li>
                            <li><strong>Place 2:</strong> Running a real creator business, waking up to payments, and living your dream</li>
                        </ul>
                    ...
                    <p className="text-purple-800 font-semibold">
                        ...
                        Show me ANY other investment that returns 30x. I'll wait.
                    </p>

                    <Separator />

                    <div>
                        <h3 className="font-bold text-gray-900 mb-2">Last Chance. I Mean It.</h3>
                        <p>After you close this pop-up:</p>
                        <ul className="list-disc pl-5 space-y-1">
                ...
                <div className="text-sm text-yellow-800 mt-4 space-y-2">
                    <p className="font-semibold">
                        P.S. - Every minute you wait, another creator is implementing these systems and making the money that could be yours. Don't let fear of investing €297 cost you €100,000+ in future revenue. That's just bad math.
